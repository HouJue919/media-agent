...
Current development milestone: v0.2.4 Video Stability Scoring
...
The current development milestone is **v0.2.4 Video Stability Scoring**.
...
A static video quality report with a dashboard, keyframe previews, search, recommendation filtering, manual decision buttons, and `video_decisions.csv` export.
